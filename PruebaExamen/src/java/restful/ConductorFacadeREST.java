...
public class ConductorFacadeREST extends AbstractFacade<Conductor> {
    ...
    public List<Conductor> findConductorBySexo(@PathParam("sexo") String sexo) throws SelectCollectionException {
        List<Conductor> elconductor=null;
        try{
            elconductor = em.createNamedQuery("findConductorBySexo")
                    .setParameter("sexo", Sexo.valueOf(sexo))
                    .getResultList();
