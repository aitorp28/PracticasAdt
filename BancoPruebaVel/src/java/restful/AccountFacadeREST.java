...
public class AccountFacadeREST extends AbstractFacade<Account> {
    ...
    public List<Account> listbybalance(@PathParam("balance") Float balance) throws SelectCollectionException {
       List<Account> resultados= null;
        try{
            resultados=  em.createNamedQuery("listbybalance")
