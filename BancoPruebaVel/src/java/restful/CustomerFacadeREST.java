...
public class CustomerFacadeREST extends AbstractFacade<Customer> {
    ...
    public List<Customer> ListByFirstName(@PathParam("name") String name) throws SelectCollectionException {
        
         List<Customer> names=null;
        
        try{
           
           names= em.createNamedQuery("ListByFirstName")
